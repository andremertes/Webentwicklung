...
<div id="sidebar" class="col-lg-2">
    <ul class="list-group">
        ...
        <ul>
            ...
            <a class="list-group-item list-group-item-action <?php if ($title=='Aufgaben'){echo 'active';} ?>" href="<?= base_url() ?>/aufgaben" <?php if (!(isset($_SESSION['aktivesprojekt']))){echo 'hidden';}?>>Aufgaben</a>
